...
export default function Project({ project }: { project: ProjectType }) {
  ...
  return (
    <>
      ...
      <div className="text-gray-500 mb-1 text-sm font-[family-name:var(--font-metrophobic)]">
        {project.summary || "[Summary]"}
      </div>
      {hasChallenges && (
        <>
          <div className="text-gray-800 font-bold mb-0 mt-2 text-[10px] uppercase font-[family-name:var(--font-metrophobic)]">
            Challenge
          </div>
          <div className="text-gray-500 mb-1 mt-0 text-sm font-[family-name:var(--font-metrophobic)]">
        ...
        <>
          ...
          <div className="text-sm">
            {project.actions?.map((action) => (
              <div
                key={action.id}
                className="flex items-baseline text-gray-500 text-sm font-[family-name:var(--font-metrophobic)]"
              >
                <div className="mr-1">
