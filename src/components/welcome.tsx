  ...
  return (
    <>
      <div className="flex items-end justify-between w-full">
        ...
        <div className="font-[family-name:var(--font-orbitron)] font-semibold italic text text-l uppercase text-[#2ef82c]">
      ...
      <div className="font-[family-name:var(--font-metrophobic)] text-sm">
        ...
        leverage{" "}
        <span className="font-bold text-[#2ef82c]">
        ...
        rendering (<span className="font-bold text-[#2ef82c]">SSR</span>). I am
        interested in maximizing the exciting potential of{" "}
        <span className="text-[#2ef82c] font-bold">AI</span> tools and
